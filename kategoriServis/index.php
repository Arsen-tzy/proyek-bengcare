<?php
// Session untuk mengecek apakah karyawan sudah login
session_start();
...
// Query untuk mengambil data karyawan yang login
...
<head>
    ...
    <title>Data Kategori Layanan - BengCare</title>
    ...
    <div class="staff-wrap" style="background-color: transparent !important;">
        ...
        <main class="staff-main p-4 p-md-5" style="background-color: transparent !important;">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                <div>
                    <h1 class="panel-title text-white" style="font-size: 2.2rem;">Kategori Layanan</h1>
                    <p class="panel-sub text-white-50">Kelola kategori servis kendaraan seperti Servis Motor, Servis Mobil, dll.</p>
                ...
                <div class="card-body p-4">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php
                                // Melakukan JOIN untuk mendapatkan nama karyawan
                                $query = "SELECT kategori_layanan.*, karyawan.nama AS nama_karyawan 
                                          FROM kategori_layanan 
                                          LEFT JOIN karyawan ON kategori_layanan.id_karyawan = karyawan.id 
                                          ORDER BY kategori_layanan.id DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="fw-semibold text-dark"><?= htmlspecialchars(ucwords($data['nama_kategori'])); ?></td>
                                        <td class="text-secondary"><?= htmlspecialchars($data['nama_karyawan'] ? ucwords($data['nama_karyawan']) : '-'); ?></td>
                                        <td class="text-center">
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="edit.php?id=<?= $data['id']; ?>" class="btn btn-warning btn-sm rounded-3" title="Edit">
                                                    <i class="bi bi-pencil-square text-dark"></i>
                                                </a>
                                                <a href="hapus.php?id=<?= $data['id']; ?>" class="btn btn-danger btn-sm rounded-3" title="Hapus" onclick="return confirm('Yakin ingin menghapus kategori ini?');">
